...
export function createCarrierData(data) {
  ...
  return array.map((carrier) => ({
    ...carrier,
    pickupEnabled: configBus.get(SETTINGS.ALLOW_PICKUP_LOCATIONS, null, carrier.name),
    deliveryEnabled: configBus.get(SETTINGS.ALLOW_DELIVERY_OPTIONS, null, carrier.name),
  }));
}
