...
<form id="mypa-delivery-option-form" class="" action="." enctype="multipart/form-data" method="post" target="_self">
	<fieldset class="mypa-fieldset">
		...
		<ul id="mypa-pre-selectors-nl">
			...
			<li id="mypa-postnl-recipient-only">
		...
		<ul id="mypa-delivery-selectors-nl">
			<li id="mypa-postnl-recipient-only" class="mypa-delivery-option method-myparcel-flatrate-div">
			...
			<li id="mypa-postnl-signature" class="mypa-delivery-option method-myparcel-delivery-signature-div">
			...
			<li id="mypa-postnl-recipient-only" class="mypa-delivery-option method-myparcel-delivery-only-recipient-div">
			...
			<li id="mypa-postnl-signature-recipient-only" class="mypa-delivery-option method-myparcel-delivery-signature-and-only-recipient-fee-div">
